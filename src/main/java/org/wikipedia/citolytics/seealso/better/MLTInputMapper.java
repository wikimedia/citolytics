 ...
 */
public class MLTInputMapper extends RichFlatMapFunction<String, RecommendationSet> {
    ...
    @Override
    public void flatMap(String s, Collector<RecommendationSet> out) throws Exception {
        ...
        try {
            ...
            out.collect(new RecommendationSet(cols[0], results));
        } catch (Exception e) {
