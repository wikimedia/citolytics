...
public class CPIAnalysis extends WikiSimAbstractJob<Tuple5<String, String, Double, Integer, Integer>> {
    ...
    public void plan() throws Exception {
        ...
        String clickStreamsPath = getParams().getRequired("clickstreams");
...
//                .filter(new ArticleFilter<>(articles, ArticleStatsTuple.ARTICLE_NAME_KEY))
                ;

        DataSet<ClickStreamTuple> clickStreams =
                ClickStreamHelper.getTranslatedClickStreamDataSet(env, clickStreamsPath, lang,
        ...
        result = recommendations
                ...
                .with(new JoinFunction<Recommendation, ArticleStatsTuple, Tuple5<String, String, Double, Integer, Integer>>() {
                    @Override
                ...
                .with(new CoGroupFunction<Tuple5<String, String, Double, Integer, Integer>, ClickStreamTuple, Tuple5<String, String, Double, Integer, Integer>>() {
                    @Override
